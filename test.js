...
describe('Test Suite', () => {
    ...
    it('Test Case 1 - fashion', async () => {
        ...
        await registration.enterRegistrationDetails('hardik', 'pansani', 'pachanihardik377@gmail.com', 'Hardik@123', 'Hardik@123');
    ...
    it('Test Case 2 - santander', async () => {
        ...
        await driver.wait(until.elementLocated(registration.firstNameInput));
        await registration.enterRegistrationDetails('hardik', 'pansani', 'pachanihardik379@gmail.com', 'Hardik@123', 'Hardik@123');
        await registration.clickSubmitButton();
